========================================================================
    ACTIVEX 控件 DLL : QRob_Usher 项目概述
========================================================================

控件向导已为 QRob_Usher ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 QRob_Usher ActiveX 控件 DLL 的每个文件的内容。
...
QRob_UsherCtrl.h
    此文件包含 CQRob_UsherCtrl C++ 类的声明。

QRob_UsherCtrl.cpp
    此文件包含 CQRob_UsherCtrl C++ 类的实现。

QRob_UsherPropPage.h
    此文件包含 CQRob_UsherPropPage C++ 类的声明。

QRob_UsherPropPage.cpp
    此文件包含 CQRob_UsherPropPage C++ 类的实现。

CQRob_UsherCtrl.bmp
    此文件包含一个位图，当 CQRob_UsherCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 QRob_Usher.pch 的预编译头 (PCH) 文件和名为 
